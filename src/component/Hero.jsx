        ...
        <div className="hero-content mx-auto flex-col md:flex-row-reverse md:gap-6 gap-16 ">
          ...
          <div className="p-6 ">
            ...
            <p className="py-6 text-justify">
              You can call me Muza, I'm a front-end enthusiast with a passion for building interactive experiences. With a growing interest in graphic design, I'm excited to share my portfolio with you. Scroll down to explore my coding journey and see my ideas come to life.
            </p>
